...
import UpdateToDoHook from "../hooks/UpdateToDoHook"
...
const UpdateToDo = (props) => {
    const {id} = useParams()
    const {toDoState, setToDoState, formErrors, notRequired, handleChange} = UpdateToDoHook()
    ...
    const handleSubmit = async (e) => {
        ...
        ToDoService.updateOneToDo(id, toDoState)
            .then(res => {
            console.log(res)
            navigate('/tradesheet')
            })
        ...
        <div className="tradeFormContainer">
            ...
            <form className="tradeForm" onSubmit={handleSubmit}>
                <div className="formCol">
                    ...
                    <input type="date" name="date" id="date" value={dateFormat(toDoState.date)} onChange={handleChange} />
                    ...
                    <button className="confirmTrade" type="submit" disabled={!validateForm()}>Update To Do</button>
                </div>
